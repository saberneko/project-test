...
<div id="item2" class="mui-control-content mui-active">
  <ul class="mui-table-view">
    <router-link tag="li" class="'mui-table-view-cell mui-media'" v-for="(expert, index) in expertsInfo" :to="{ path: '/expertdetail/' + expert.GP_ManitoId + '/' + index}" :key="expert.GP_ManitoId">
      ...
      <button class="mui-btn mui-good-btn" style="font-size:14px; border: 0px;float:right;margin-top:10px" v-bind:class="[!expert.IsMy ? 'mui-text-goodColor' : 'mui-text-primaryColor']" v-on:click.stop="setLike(expert.GP_ManitoId)">
          <!-- <img  class="mui-img-good" :src="'static/img/' + expert.like + '.png'" /> -->
          <img class="mui-img-good" :src="!expert.IsMy ? thumbup : thumbdown" />
...
let thumbup = require('../../static/images/good-filled.png')// zan
// let thumbdown = require('../../static/images/good.png')// no zan
...
export default {
  ...
  data () {
    return {
      expertsInfo: null,
      thumbup: '../../static/images/good-filled.png',
      // thumbup,
      thumbdown: '../../static/images/good.png',
    }
  },
